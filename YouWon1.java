...
public class YouWon1 extends GameSceneNew{

    private static ActionListener listener;
    private static String BACKGROUND = "forest_out.png";
    ...
    public static void scenePlot(){
        ...
        JLabel win1 = new JLabel("Congratulations, you escaped the forest! But this isn't your only path to survival...");
