...
public class YouWon2 extends GameSceneNew{

    private static ActionListener listener;
    private static String BACKGROUND = "firehouse.png";
    ...
    public static void scenePlot(){
        ...
        JLabel win1 = new JLabel("Congratulations, you destroyed the house and won! But this isn't your only path to survival...");
